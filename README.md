<h1 align="center">
  <br>
  Git Profiler <b>v0.8.1</b> <i>(PBR21M1)</i>
  <br>
</h1>
...
The research paper can be found under [`./paper](./paper). You have to have _LaTeX_ compiler installed (for example.: [miktex](https://miktex.org/)) in order to recreate `.pdf` file.
